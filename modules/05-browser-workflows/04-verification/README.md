...
Run `pytest -q` from the module directory. A completed module has a passing solution-equivalent test, no unhandled browser resources, and a learner who can explain every assertion and fixture involved.
